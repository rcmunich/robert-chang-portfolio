export const portfolioData = {
  ...
  experience: [
    ...
    {
      id: 4,
      company: "Eminex International Consulting",
      position: "Founder / Managing Director",
      duration: "October 2005 - October 2007 (2 years)",
      location: "Global",
      description: "Founded international consulting firm specializing in technology market entry strategies.",
      achievements: [
        "Established consulting practice serving Fortune 500 clients",
        "Facilitated market entry for 12+ technology companies",
        "Generated $2M+ in revenue within first 18 months",
        "Built network of partners across 3 continents"
      ]
    },
    {
      id: 5,
      ...
      duration: "2003 - 2005 (2 years)",
      location: "Santa Clara, California",
      description: "Led global marketing efforts for enterprise mobile solutions pioneer.",
      achievements: [
        "Launched products in 15+ international markets",
        "Increased market share by 150% in enterprise segment",
        "Managed $10M+ marketing budget",
        "Built strategic partnerships with major carriers"
      ]
    }
  ],
